...
PREFLIGHT_PATH = "/internal/supervised-pilot-first-send-preflight"
...
def test_supervised_pilot_first_send_preflight_open_in_development(
...
def test_supervised_pilot_first_send_preflight_rejects_non_development_without_key(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_supervised_pilot_first_send_preflight_rejects_invalid_key_and_disallows_post(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    _patch_settings(
...
def test_supervised_pilot_first_send_preflight_api_redacts_secrets_and_stays_read_only(
    api_client: TestClient,
    db_session: Session,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    created = SettingsChangeRequestService().create(
        ...
        idempotency_key="api-supervised-pilot-first-send-preflight",
