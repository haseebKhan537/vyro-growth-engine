...
def test_deployment_runbook_covers_operator_topics() -> None:
    ...
    assert "operator-launch-blockers-plan" in runbook
    assert "vyro-growth launch-blockers-plan" in runbook
    assert "/internal/staged-rollout-plan" in runbook
    ...
    assert "operator-go-live-rehearsal-checklist" in runbook
    assert "vyro-growth go-live-rehearsal-checklist" in runbook
    assert "/internal/rehearsal-outcome-report" in runbook
    assert "operator-rehearsal-outcome-report" in runbook
    assert "vyro-growth rehearsal-outcome-report" in runbook
    assert "/internal/supervised-pilot-plan" in runbook
    assert "operator-supervised-pilot-plan" in runbook
    assert "vyro-growth supervised-pilot-plan" in runbook
    assert "/internal/supervised-pilot-candidates" in runbook
    ...
    assert "/internal/supervised-pilot-first-send-preflight" in runbook
    assert "operator-supervised-pilot-first-send-preflight" in runbook
    assert "vyro-growth supervised-pilot-first-send-preflight" in runbook
