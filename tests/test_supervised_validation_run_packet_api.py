...
from tests.test_supervised_validation_run_packet_service import _assert_no_execution
...
PACKET_PATH = "/internal/supervised-validation-run-packet"
...
def test_packet_api_redacts_secrets_and_stays_read_only(
    ...
    response = api_client.get(
        PACKET_PATH,
        headers={"X-Internal-Api-Key": "internal-secret"},
        params={"state": "TX", "max_cohort_size": 200},
    )
...
def test_invalid_cohort_size_is_rejected(
    ...
    response = api_client.get(PACKET_PATH, params={"max_cohort_size": 201})
