...
from tests.test_provider_setup_checklist_service import _assert_no_execution
...
CHECKLIST_PATH = "/internal/provider-setup-checklist"
...
def test_provider_setup_checklist_open_in_development(
    ...
    assert "local_verification_gates" in body
...
def test_provider_setup_checklist_rejects_non_development_without_key(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_provider_setup_checklist_rejects_invalid_key_and_disallows_post(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    _patch_settings(
...
def test_provider_setup_checklist_api_redacts_secrets_and_stays_read_only(
    api_client: TestClient,
    db_session: Session,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    created = SettingsChangeRequestService().create(
        ...
        idempotency_key="api-provider-setup-checklist",
    ...
    assert body["provider_setup_checklist_is_not_go_live"] is True
    assert body["checklist_is_not_permission_to_go_live"] is True
