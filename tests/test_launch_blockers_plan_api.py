...
from tests.test_launch_blockers_plan_service import _assert_no_execution
...
PLAN_PATH = "/internal/launch-blockers-plan"
...
def test_launch_blockers_plan_open_in_development(
    ...
    assert body["source_index_route"] == "/internal/go-live-readiness-index"
...
def test_launch_blockers_plan_rejects_non_development_without_key(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_launch_blockers_plan_rejects_invalid_key_and_disallows_post(
    api_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    _patch_settings(
...
def test_launch_blockers_plan_api_redacts_secrets_and_stays_read_only(
    api_client: TestClient,
    db_session: Session,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    assert body["plan_is_not_execution"] is True
