...
def _next_actions(
    *,
    ...
    add(
        NextActionCode.OWNER_LAUNCH_DOSSIER_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="owner_launch_dossier",
    )
    add(
        NextActionCode.PROVIDER_SETUP_CHECKLIST_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="provider_setup_checklist",
    )
    add(
        NextActionCode.GO_LIVE_REHEARSAL_CHECKLIST_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="go_live_rehearsal_checklist",
    )
    add(
        NextActionCode.REHEARSAL_OUTCOME_REPORT_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="rehearsal_outcome_report",
    )
    add(
        NextActionCode.SUPERVISED_PILOT_PLAN_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
    ...
    add(
        NextActionCode.SUPERVISED_PILOT_GO_NO_GO_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="supervised_pilot_go_no_go",
    )
    add(
        NextActionCode.SUPERVISED_PILOT_FIRST_SEND_PREFLIGHT_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="supervised_pilot_first_send_preflight",
    )
    add(
        NextActionCode.SUPERVISED_PILOT_LAUNCH_REHEARSAL_CONTROL_MAP_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="supervised_pilot_launch_rehearsal_control_map",
    )
    add(
        NextActionCode.SUPERVISED_PILOT_FIRST_SEND_OWNER_AUTHORIZATION_PACKET_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="supervised_pilot_first_send_owner_authorization_packet",
    )
    add(
        NextActionCode.LIVE_PROVIDER_SETUP_CHECKLIST_IS_NOT_GO_LIVE,
        FindingSeverity.INFO,
        phase="live_provider_setup_checklist",
    )
    add(
        NextActionCode.SUPERVISED_VALIDATION_RUN_GATE_IS_NOT_EXECUTION,
        FindingSeverity.INFO,
        phase="supervised_validation_run_gate",
    )
