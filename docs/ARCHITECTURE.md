...
4. Rendered HTML never includes message bodies, draft copy, emails, phones, evidence snippets, API keys, env secret values, PHI, or raw error text. There are no approve/reject/execute/send/enroll/book/call/publish/spend/deploy controls.
