...
7. Run `vyro-growth operator-command-center`, open `GET /internal/operator-dashboard`, and `vyro-growth system-status` and review findings before any manual rollout. See `docs/OPERATOR_HEALTH.md`.
