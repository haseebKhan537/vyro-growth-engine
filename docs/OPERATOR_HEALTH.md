...
- Pending operator-review counts: personalization drafts, planned enrollments, booking plans, voice plans, optimizer recommendations
...
6. Review pending drafts, enrollment plans, booking plans, voice plans, and optimizer recommendations on their existing dry-run surfaces.
