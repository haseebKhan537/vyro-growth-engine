...
- Dashboard, monitoring, command-center, operator-dashboard, operator review-queue UI, operator approval-packet UI, operator action-readiness UI, operator settings-change request list, operator settings-execution preflight, operator owner-handoff packet, operator activity audit timeline, operator compliance evidence binder, operator release-candidate runbook, operator release artifact manifest, operator go-live readiness index, operator launch blockers remediation plan, operator staged go-live rollout plan, operator owner launch dossier, operator provider setup checklist, operator go-live rehearsal checklist, operator rehearsal outcome report, operator supervised pilot launch plan, operator supervised pilot candidate readiness, operator supervised pilot go/no-go, operator supervised pilot first-send preflight, operator supervised pilot launch rehearsal control map, operator contact-validation, operator supervised validation run packet, final-safety-audit, supervised-pilot-first-send-preflight, supervised-pilot-launch-rehearsal-control-map, supervised-pilot-first-send-owner-authorization-packet, launch-readiness, owner-handoff-packet, compliance-evidence-binder, release-candidate-runbook, release-artifact-manifest, go-live-readiness-index, launch-blockers-plan, staged-rollout-plan, owner-launch-dossier, provider-setup-checklist, go-live-rehearsal-checklist, rehearsal-outcome-report, supervised-pilot-plan, supervised-pilot-candidates, and supervised-pilot-go-no-go routes are read-only. CLI (`vyro-growth dashboard-summary`, `vyro-growth system-status`, `vyro-growth operator-command-center`, `vyro-growth action-readiness`, `vyro-growth compliance-evidence-binder`, `vyro-growth release-candidate-runbook`, `vyro-growth release-artifact-manifest`, `vyro-growth go-live-readiness-index`, `vyro-growth launch-blockers-plan`, `vyro-growth staged-rollout-plan`, `vyro-growth owner-launch-dossier`, `vyro-growth provider-setup-checklist`, `vyro-growth go-live-rehearsal-checklist`, `vyro-growth rehearsal-outcome-report`, `vyro-growth supervised-pilot-plan`, `vyro-growth supervised-pilot-candidates`, `vyro-growth supervised-pilot-go-no-go`, `vyro-growth supervised-pilot-first-send-preflight`, `vyro-growth supervised-pilot-launch-rehearsal-control-map`, `vyro-growth supervised-pilot-first-send-owner-authorization-packet`, `vyro-growth final-safety-audit`) does not use the HTTP key and does not write pipeline state. The HTML dashboard and drilldowns are HTTP-only and do not change operator halt state.
- `GET /internal/dashboard/summary`, `GET /internal/dashboard/safety`, `GET /internal/email-verification/metrics`, `GET /internal/contact-validation/plan`, `GET /internal/contact-validation/report`, `GET /internal/supervised-validation-run-packet`, `GET /internal/live-provider-setup-checklist`, `GET /internal/supervised-validation-run`, `GET /internal/phone-verification/tasks`, `POST /internal/phone-verification/tasks/{task_id}/outcome`, `GET /internal/monitoring/status`, `GET /internal/operator-command-center`, `GET /internal/operator-dashboard`, `GET /internal/operator-review-queue`, `POST /internal/operator-review-queue/{artifact_type}/{artifact_id}/decision`, `GET /internal/operator-approval-packets`, `POST /internal/operator-approval-packets/{packet_id}/decision`, `GET /internal/operator-action-readiness`, `GET /internal/operator-settings-change-requests`, `POST /internal/operator-settings-change-requests/{request_id}/decision`, `GET /internal/operator-settings-execution-preflight`, `GET /internal/operator-owner-handoff-packet`, `GET /internal/operator-audit-timeline`, `GET /internal/operator-compliance-evidence-binder`, `GET /internal/operator-release-candidate-runbook`, `GET /internal/operator-release-artifact-manifest`, `GET /internal/operator-go-live-readiness-index`, `GET /internal/operator-launch-blockers-plan`, `GET /internal/operator-staged-rollout-plan`, `GET /internal/operator-owner-launch-dossier`, `GET /internal/operator-provider-setup-checklist`, `GET /internal/operator-go-live-rehearsal-checklist`, `GET /internal/operator-rehearsal-outcome-report`, `GET /internal/operator-supervised-pilot-plan`, `GET /internal/operator-supervised-pilot-candidates`, `GET /internal/operator-supervised-pilot-go-no-go`, `GET /internal/operator-supervised-pilot-first-send-preflight`, `GET /internal/operator-supervised-pilot-launch-rehearsal-control-map`, `GET /internal/operator-contact-validation`, `GET /internal/operator-supervised-validation-run-packet`, `GET /internal/owner-handoff-packet`, `GET /internal/compliance-evidence-binder`, `GET /internal/release-candidate-runbook`, `GET /internal/release-artifact-manifest`, `GET /internal/go-live-readiness-index`, `GET /internal/launch-blockers-plan`, `GET /internal/staged-rollout-plan`, `GET /internal/owner-launch-dossier`, `GET /internal/provider-setup-checklist`, `GET /internal/live-provider-setup-checklist`, `GET /internal/go-live-rehearsal-checklist`, `GET /internal/rehearsal-outcome-report`, `GET /internal/supervised-pilot-plan`, `GET /internal/supervised-pilot-candidates`, `GET /internal/supervised-pilot-go-no-go`, `GET /internal/supervised-pilot-first-send-preflight`, `GET /internal/supervised-pilot-launch-rehearsal-control-map`, `GET /internal/supervised-pilot-first-send-owner-authorization-packet`, `GET /internal/action-readiness`, `GET /internal/review-queue`, `POST /internal/review-queue/decisions`, `POST /internal/execution-plans/run`, and `GET /internal/execution-plans` are internal operator routes, not a public API.
- NPPES discovery itself remains a non-outbound ingestion job. CLI (`vyro-growth discover-nppes`) and worker job `discover_nppes_practices` do not use the HTTP key.
- Dashboard, monitoring, command-center, operator-dashboard, operator review-queue UI, operator approval-packet UI, operator action-readiness UI, operator settings-change request list, operator settings-execution preflight, operator owner-handoff packet, operator activity audit timeline, operator compliance evidence binder, operator release-candidate runbook, operator release artifact manifest, operator go-live readiness index, operator launch blockers remediation plan, operator staged go-live rollout plan, operator owner launch dossier, operator provider setup checklist, operator go-live rehearsal checklist, operator rehearsal outcome report, operator supervised pilot launch plan, operator supervised pilot candidate readiness, operator supervised pilot go/no-go, operator supervised pilot first-send preflight, operator supervised pilot launch rehearsal control map, operator contact-validation, operator supervised validation run packet, supervised-pilot-first-send-preflight, supervised-pilot-launch-rehearsal-control-map, supervised-pilot-first-send-owner-authorization-packet, launch-readiness, owner-handoff-packet, compliance-evidence-binder, release-candidate-runbook, release-artifact-manifest, go-live-readiness-index, launch-blockers-plan, staged-rollout-plan, owner-launch-dossier, provider-setup-checklist, go-live-rehearsal-checklist, rehearsal-outcome-report, supervised-pilot-plan, supervised-pilot-candidates, and supervised-pilot-go-no-go routes are read-only. CLI (`vyro-growth dashboard-summary`, `vyro-growth system-status`, `vyro-growth operator-command-center`, `vyro-growth action-readiness`, `vyro-growth compliance-evidence-binder`, `vyro-growth release-candidate-runbook`, `vyro-growth release-artifact-manifest`, `vyro-growth go-live-readiness-index`, `vyro-growth launch-blockers-plan`, `vyro-growth staged-rollout-plan`, `vyro-growth owner-launch-dossier`, `vyro-growth provider-setup-checklist`, `vyro-growth live-provider-setup-checklist`, `vyro-growth supervised-validation-run`, `vyro-growth go-live-rehearsal-checklist`, `vyro-growth rehearsal-outcome-report`, `vyro-growth supervised-pilot-plan`, `vyro-growth supervised-pilot-candidates`, `vyro-growth supervised-pilot-go-no-go`, `vyro-growth supervised-pilot-first-send-preflight`, `vyro-growth supervised-pilot-launch-rehearsal-control-map`, `vyro-growth supervised-pilot-first-send-owner-authorization-packet`) does not use the HTTP key and does not write pipeline state. The HTML dashboard and drilldowns are HTTP-only and do not change operator halt state.
- Review-queue list is read-only over stored artifacts. `record-review` writes a decision and audit row only; it does not execute the artifact. Phone-verification listing is read-only. Recording a `contact_discovery_call` outcome stores a human-entered result only and never places a call.
...
## Email verification integrity
- Phase 69 plans verification and pattern inference only. It does not send email, enroll live campaigns, or contact SMTP recipient servers.
- Live verifier config (`EMAIL_VERIFICATION_LIVE_ENABLED`, API key/base URL) is disabled by default. CI and local tests use the stub and do not require a live key. Never commit API keys.
- `EMAIL_VERIFICATION_SMTP_ENABLED` must remain false. Recipient-server SMTP validation is forbidden in this phase.
- Do not invent emails. Pattern inference requires an already verified same-domain business email whose local-part uniquely matches a known public name pattern. Inferred candidates stay inferred/unverified until a verifier confirms them.
- Hard-bounce and unverifiable results are a normal `NO_VERIFIED_EMAIL` outcome, not a failure. Future outreach enrollment requires a verified-safe (`valid`) verdict.
- Metrics, logs, and operator JSON never expose real emails, phones, names, evidence snippets, provider secrets, tokens, raw env values, or unsafe errors.
...
## Phone verification integrity
- Phase 70 queues human-in-the-loop `contact_discovery_call` tasks when enrichment cannot find a reachable decision-maker. It does not place calls.
- Do not route through `VoiceProvider`. Do not autodial, use AI voice, or call phone APIs.
...
## Contact-enrichment validation integrity
- Phase 71 measures stored funnel outcomes for a bounded cohort of up to 200 practices. It does not send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, or lift halt.
- CLI `contact-validation-plan` / `contact-validation-report` / `supervised-validation-run-packet` / `final-safety-audit` / `supervised-validation-run` and JSON `GET /internal/contact-validation/plan` / `GET /internal/contact-validation/report` / `GET /internal/supervised-validation-run-packet` / `GET /internal/final-safety-audit` / `GET /internal/supervised-validation-run` are read-only. CI/defaults never call Apollo, Hunter, NeverBounce, ZeroBounce, OpenAI, Smartlead, calendar, or voice providers.
- Output is aggregate counts, rates, filters, run IDs, and status/code rollups only. Never expose emails, phones, websites, NPI numbers, street addresses, practice names, provider names, contact names, evidence snippets, message bodies, outreach drafts, secrets, tokens, raw env values, or unsafe errors.
- `NO_CONTACT_FOUND` is a normal path, not a failure. Go/no-go threshold fields are owner-review metadata and must not change scoring thresholds or live settings.
- `supervised_validation_run_permitted` stays false. After the owner explicitly approves live provider credentials, existing safe stages may be rerun; this harness still does not send.
- Phase 72 operator contact-validation UI is a sanitized read-only HTML shell of that same Phase 71 plan/report. It never executes stages, calls providers, contacts prospects, sends, enrolls, calls, books, spends, publishes, or deploys.
- Phase 73 supervised validation owner approval/run packet (`vyro-growth supervised-validation-run-packet` and `GET /internal/supervised-validation-run-packet`) reuses those Phase 71/72 surfaces as a review-only export. It never executes the run, grants approval, or sets `owner_approved` / `supervised_validation_run_permitted`.
- Phase 74 operator supervised validation run packet UI is a sanitized read-only HTML shell of that same Phase 73 packet. It never executes the run, grants approval, calls providers, contacts prospects, sends, enrolls, calls, books, spends, publishes, or deploys.
- Phase 75 final safety and repository audit packet (`vyro-growth final-safety-audit` and `GET /internal/final-safety-audit`) reuses launch-readiness, contact-validation, provider-setup, manifest, runbook, and dossier surfaces as a review-only export. It never executes validation, grants approval, or sets `owner_approved` / `supervised_validation_run_permitted`.
- Phase 76 owner live-provider setup checklist (`vyro-growth live-provider-setup-checklist` and `GET /internal/live-provider-setup-checklist`) reuses provider setup, launch readiness, the Phase 73 packet, settings preflight, and the compliance binder as a review-only credential readiness export. It never verifies credentials, calls providers, executes the run, or grants approval.
- Phase 77 supervised 200-practice validation run gate (`vyro-growth supervised-validation-run --dry-run` and `GET /internal/supervised-validation-run`) reuses those Phase 76/73/71 surfaces as a default-refusing owner-approval-required preflight. It never executes the run, grants approval, or sets `owner_approved` / `validation_permitted` / `supervised_validation_run_permitted`.
- No LinkedIn/Sales Navigator automation and no AI voice cold calling.
- `OUTBOUND_ENABLED` remains false by default. Operator halt semantics are unchanged.
...
- Phase 69 adds a verification gate: enrollment planning requires a verified-safe email-verifier verdict. Unverified, inferred-unverified, catch-all, disposable, or risky addresses skip with `NO_VERIFIED_EMAIL`.
...
## Supervised pilot first-send preflight integrity
- Phase 61 supervised pilot first-send preflight CLI and JSON are a sanitized read-only review export over the existing Phase 59 go/no-go packet, Phase 55 supervised pilot plan, candidate readiness, provider setup, rehearsal outcome, launch readiness, review/action-readiness, owner-approval, settings-request, and operator-halt surfaces. They never execute commands, scrape, select candidates, send, build, publish, deploy, spend, or perform a live workflow.
- Phase 62 operator supervised pilot first-send preflight UI is a sanitized read-only HTML shell of that same Phase 61 packet. It never executes, scrapes, selects candidates, sends, builds, publishes, deploys, spends, or performs a live workflow.
- Do not change `OUTBOUND_ENABLED`, provider live flags, deployment settings, campaign live settings, scoring thresholds, or operator halt.
- Do not apply settings, execute settings requests, set live `owner_approved`, execute review items/approval packets, send email, enroll campaigns, generate sendable autonomous replies, place calls, book meetings, create Google Meet links, publish content, launch ads, spend money, build containers, publish artifacts, or deploy.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, mutators, or a script runner.
- Export count-only first-send scope limits, go/no-go status reuse, preflight checks, abort/stop conditions as review text, expected safe assertion keys, missing credential/config names, closed provider/live flag names, route names, command names, sanitized timestamps, counts, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The export must state `go_live_permitted=false`, `execution_allowed=false`, `first_send_allowed=false`, `first_send_executed=0`, `deployment_allowed=false`, `settings_applied=false`, `halt_changed=false`, `owner_approved=false`, `spend_allowed=false`, `OUTBOUND_ENABLED=false`, `supervised_pilot_first_send_preflight_is_not_go_live=true`, `first_send_preflight_is_not_a_send=true`, and that this is a first-send preflight review export only, not permission to send, not permission to go live, and not an execution surface.

## Supervised pilot launch rehearsal control map integrity
- Phase 63 supervised pilot launch rehearsal control map CLI and JSON are a sanitized read-only review export over existing halt, outbound, supervised-pilot, approval, settings, launch-readiness, rehearsal, provider-setup, compliance, and release surfaces. They never execute commands, scrape, select candidates, send, build, publish, deploy, spend, or perform a live workflow.
- Phase 64 operator supervised pilot launch rehearsal control map UI is a sanitized read-only HTML shell of that same Phase 63 packet. It never executes, scrapes, selects candidates, sends, builds, publishes, deploys, spends, or performs a live workflow.
- Do not change `OUTBOUND_ENABLED`, provider live flags, deployment settings, campaign live settings, scoring thresholds, or operator halt.
- Do not apply settings, execute settings requests, set live `owner_approved`, execute review items/approval packets, send email, enroll campaigns, generate sendable autonomous replies, place calls, book meetings, create Google Meet links, publish content, launch ads, spend money, build containers, publish artifacts, or deploy.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, mutators, or a script runner.
- Export control nodes with category/code/status/blocking boolean/route/command names, blocking status rollups and safe counts only, remaining owner approval type names, missing credential/config names, closed provider/live flag names, route names, command names, sanitized timestamps, counts, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The export must state `go_live_permitted=false`, `execution_allowed=false`, `first_send_allowed=false`, `first_send_executed=0`, `deployment_allowed=false`, `settings_applied=false`, `halt_changed=false`, `owner_approved=false`, `spend_allowed=false`, `OUTBOUND_ENABLED=false`, `supervised_pilot_launch_rehearsal_control_map_is_not_go_live=true`, `rehearsal_control_map_is_not_a_script_runner=true`, `control_map_is_not_execution=true`, and that this is a control-map review export only, not a script runner, not permission to send, not permission to go live, and not an execution surface.

## Supervised pilot first-send owner authorization packet integrity
- Phase 65 supervised pilot first-send owner authorization packet CLI and JSON are a sanitized read-only review export over the existing Phase 61 first-send preflight, Phase 63 launch rehearsal control map, supervised-pilot go/no-go/plan/candidates, owner approval/settings request rollups, launch blockers, readiness index, rehearsal, provider-setup, compliance, and release surfaces. They never execute commands, scrape, select candidates, send, approve, build, publish, deploy, spend, or perform a live workflow.
- Do not change `OUTBOUND_ENABLED`, provider live flags, deployment settings, campaign live settings, scoring thresholds, or operator halt.
- Do not apply settings, execute settings requests, set live `owner_approved`, create or mutate approval records, execute review items/approval packets, send email, enroll campaigns, generate sendable autonomous replies, place calls, book meetings, create Google Meet links, publish content, launch ads, spend money, build containers, publish artifacts, or deploy.
- Do not add apply/execute/approve/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, mutators, or a script runner.
- Export source status rollups, control-map readiness counts and blocking codes, remaining approval type/code names, missing credential/config names, closed provider/live flag names, route names, command names, sanitized timestamps, counts, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The export must state `go_live_permitted=false`, `execution_allowed=false`, `first_send_allowed=false`, `first_send_executed=0`, `deployment_allowed=false`, `settings_applied=false`, `halt_changed=false`, `owner_approved=false`, `this_packet_is_not_approval=true`, `authorization_granted=false`, `approval_records_mutated=false`, `spend_allowed=false`, `OUTBOUND_ENABLED=false`, `supervised_pilot_first_send_owner_authorization_packet_is_not_go_live=true`, `owner_authorization_packet_is_not_a_send=true`, `export_is_not_permission_to_send=true`, `export_is_not_execution=true`, and that this is an owner-authorization review export only, not approval, not permission to send, not permission to go live, and not an execution surface.

## Operator contact-validation UI integrity
- Phase 72 operator contact-validation UI is a sanitized read-only HTML shell of the Phase 71 contact-enrichment validation plan and report. It reuses `ContactValidationService` and never recalculates funnel readiness.
- Do not change `OUTBOUND_ENABLED`, provider live flags, scoring thresholds, or operator halt.
- Do not execute validation stages, call Apollo/Hunter/NeverBounce/ZeroBounce/OpenAI/NPPES/search/Smartlead/Calendar/voice/deployment providers, send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, lift halt, or set live `owner_approved`.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, or mutators.
- Render aggregate counts, rates, filters, statuses, codes, route/command names, live-provider booleans, sanitized timestamps, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The page must state `execution_allowed=false`, `owner_approved=false`, `supervised_validation_run_permitted=false`, `OUTBOUND_ENABLED=false`, `contact_validation_is_not_outbound=true`, `contact_validation_is_not_live_send=true`, and that this is an aggregate-only review view, not permission to run a supervised validation and not an execution surface.

## Supervised validation owner approval/run packet integrity
- Phase 73 supervised validation owner approval/run packet is a sanitized read-only export over the Phase 71 contact-validation plan/report and Phase 72 UI route names. It reuses `ContactValidationService` and never recalculates funnel readiness.
- Do not change `OUTBOUND_ENABLED`, provider live flags, scoring thresholds, or operator halt.
- Do not execute the validation run, grant approval, call Apollo/Hunter/NeverBounce/ZeroBounce/OpenAI/NPPES/search/Smartlead/Calendar/voice/deployment providers, send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, lift halt, or set live `owner_approved`.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, or mutators.
- Export aggregate counts, rates, filters, statuses, codes, route/command names, credential/config names with present/missing booleans only, live-provider booleans, sanitized timestamps, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The packet must state `execution_allowed=false`, `owner_approved=false`, `supervised_validation_run_permitted=false`, `OUTBOUND_ENABLED=false`, `export_is_not_permission_to_run=true`, `supervised_validation_run_packet_is_not_execution=true`, and that this is a planning/review artifact only, not permission to run a supervised validation and not an execution surface.

## Final safety and repository audit integrity
- Phase 75 final safety and repository audit packet is a sanitized read-only export over existing launch-readiness, contact-validation, provider-setup, manifest, runbook, and dossier surfaces. It reuses those services and never recalculates readiness.
- Do not change `OUTBOUND_ENABLED`, provider live flags, scoring thresholds, or operator halt.
- Do not execute validation, grant approval, call Apollo/Hunter/NeverBounce/ZeroBounce/OpenAI/NPPES/search/Smartlead/Calendar/voice/deployment providers, send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, lift halt, call GitHub Actions, or set live `owner_approved`.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, or mutators.
- Export phase/route/command names, migration revision/filename, live-provider booleans, statuses, codes, documentation coverage, issue numbers/titles, sanitized timestamps, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The packet must state `execution_allowed=false`, `owner_approved=false`, `supervised_validation_run_permitted=false`, `OUTBOUND_ENABLED=false`, `export_is_not_permission_to_validate=true`, `final_safety_audit_is_not_execution=true`, and that this is a planning/review artifact only, not permission to run real-world validation and not an execution surface.

## Owner live-provider setup checklist integrity
- Phase 76 owner live-provider setup checklist is a sanitized read-only export over provider setup, launch readiness, the Phase 73 supervised validation packet, settings execution preflight, and the compliance evidence binder. It reuses those services and never recalculates source-of-truth readiness.
- Do not change `OUTBOUND_ENABLED`, provider live flags, scoring thresholds, or operator halt.
- Do not verify credentials by calling providers, execute the validation run, grant approval, call Apollo/Hunter/NeverBounce/ZeroBounce/OpenAI/NPPES/search/Smartlead/Calendar/voice/deployment providers, send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, lift halt, or set live `owner_approved`.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, or mutators.
- Export credential/config names with present/missing booleans only, provider/category labels, owner decision codes with `granted=false`, budget/rate-limit placeholder labels, compliance prerequisite codes, validation constraint codes, statuses, route/command names, sanitized timestamps, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, or unsafe raw error text.
- The packet must state `execution_allowed=false`, `owner_approved=false`, `validation_permitted=false`, `supervised_validation_run_permitted=false`, `OUTBOUND_ENABLED=false`, `export_is_not_permission_to_run=true`, `live_provider_setup_checklist_is_not_go_live=true`, and that this is a planning/review artifact only, not permission to run a supervised validation and not an execution surface.

## Supervised validation run gate integrity
- Phase 77 supervised 200-practice validation run gate is a sanitized owner-approval-required refusal/preflight over the Phase 76 live-provider setup checklist, Phase 73 supervised validation packet, Phase 71 contact-validation plan/report, launch readiness, settings execution preflight, and the compliance evidence binder. It reuses those services and never recalculates source-of-truth readiness.
- Do not change `OUTBOUND_ENABLED`, provider live flags, scoring thresholds, or operator halt.
- Do not execute the validation run, grant approval, call Apollo/Hunter/NeverBounce/ZeroBounce/OpenAI/NPPES/search/Smartlead/Calendar/voice/deployment providers, send email, enroll campaigns, place calls, autodial, use AI voice, book meetings, create Meet links, launch ads, spend money, publish, deploy, apply settings, lift halt, or set live `owner_approved` / `validation_permitted`.
- Do not add apply/execute/lift-halt/enable-outbound/provider/build/publish/deploy/campaign/booking/call/spend/candidate-selection/contact controls, mutation forms, workers, or mutators.
- Export gate codes, statuses, blocking/passed flags, owner decision codes with `granted=false`, credential/config names with present/missing booleans only, compliance prerequisite codes, validation constraint codes, route/command names, sanitized timestamps, and safe local git metadata only.
- Do not export practice names, provider names, NPI numbers, street addresses, emails, phones, websites, raw evidence snippets, message bodies, outreach drafts, PHI, patient data, secret values, environment values, API keys, tokens, provider secrets, owner approval code values, or unsafe raw error text.
- The packet must state `execution_allowed=false`, `owner_approved=false`, `validation_permitted=false`, `supervised_validation_run_permitted=false`, `OUTBOUND_ENABLED=false`, `export_is_not_permission_to_run=true`, `supervised_validation_run_gate_is_not_execution=true`, and that this is a refusal/preflight artifact only, not permission to run a supervised validation and not an execution surface. The actual 200-practice validation requires separate owner approval before execution.
